          ...
          <div>
            ...
            <div className="crossfade">
             ...
             {/*
                ...
                <img id="pic5" src={'./images/dancer3.jpg'}/>
              ...
              <div id="home" className="panel">
                  <div className="inner">
                      <div id="imgchange">
                          <div className="backgroundimg" id="image1" src='./images/group5.jpg'></div>
                          <div className="backgroundimg" id="image2" src='./images/dancer7.jpg'></div>
                          <div className="backgroundimg" id="image3" src='./images/group1.jpg'></div>
                          <div className="backgroundimg" id="image4" src='./images/dancer6.jpg'></div>
                          <div className="backgroundimg" id="image5" src='./images/group2.jpg'></div>
                          <div className="backgroundimg" id="image7" src='./images/dancer4.jpg'></div>
                          <div className="backgroundimg" id="image8" src='./images/dancer5.jpg'></div>
                          <div className="backgroundimg" id="image9" src='./images/group3.jpg'></div>
                      </div>
                  </div>
              </div>
